...
class Frontend_Cart {
  ...
  function __construct() {
    ...
    // replace thumbnail
    add_filter( 'woocommerce_cart_item_thumbnail', [$this, 'change_thumbnail_size'], 111, 2 );

    // add subtotal
    add_action( 'woocommerce_cart_contents', [$this, 'add_subtotal'], 999 );

    // add checkout button
    remove_action( 'woocommerce_cart_collaterals', 'woocommerce_cart_totals', 10 );
    add_action( 'woocommerce_cart_actions', [$this, 'add_proceed_checkout_button'], 999 );
  }
