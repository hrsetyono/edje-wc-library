...
// Add thumbnail to Cart, Checkout, and Thank You page
add_filter('woocommerce_cart_item_name', 'h_cart_add_thumbnail', 10, 3);
add_filter('woocommerce_order_item_name', 'h_cart_add_thumbnail', 10, 3);
 ...
 */
function h_cart_add_thumbnail(string $name, $cart_item, $cart_item_key) : string {
